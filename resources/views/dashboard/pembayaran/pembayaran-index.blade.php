...
@section('page-title', 'Pembayaran Nasabah')
@section('content')

    <div class="container p-4">
        <a href="{{ route('pembayaran.buat') }}" class="btn btn-primary my-2"> <i class="fa fa-plus" aria-hidden="true"></i>
            Isi Pembayaran Nasabah</a>
        <table class="table table-striped table-bordered" id="table-pembayaran">
            <thead>
                <tr>
                    <th class="px-2">Kode Pembayaran</th>
                    <th class="px-2">Kode Pembiayaan</th>
                    <th class="px-2">Nama Nasabah</th>
                    <th class="px-2">Nama Penyetor</th>
                    <th class="px-2">Total Pembiayaan</th>
                    <th class="px-2">Angsuran Ke</th>
                    <th class="px-2">Angsuran Bulan</th>
                    <th class="px-2">Jumlah Bayar </th>
            ...
            $(document).ready(function() {
                $('#table-pembayaran').DataTable({
                    ...
                    columns: [
                        ...
                        {
                           data : 'pembiayaan.nomor_pembiayaan',
                           nama : 'id_pembiayaan'
                        },
                        {
                            data: 'pembiayaan.nasabah.nama',
                        },
                        ...
                        {
                            data: 'pembiayaan.total_pembiayaan'
                        },
                        {
                            data: 'angsuran_ke',
                        },
